...
@Component({
    ...
    template: `
        ...
        <div>
            <ig-combo [(options)]="comboOptions" widgetId="combo"
            [(ngModel)]="comboOptions.value" (selectionChanged)="selectionChanged($event)"></ig-combo>
    ...
    constructor() {
        ...
        this.gridOptions = {
            ...
            columns: [
                ...
                { headerText: 'Company', key: 'Company', width: '20%', dataType: 'string',
                  unbound: true, formula: function () { return 'http://infragistics.com/'; } },
