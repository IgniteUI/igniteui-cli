...
@Component({
    ...
    template: `
        <h1>$(description)</h1>
        <ig-hierarchical-grid [(options)]="gridOptions" widgetId='hierarchical-grid-editing'></ig-hierarchical-grid>
    `
})
            ...
            columnLayouts: [
                {
                    ...
                    columns: [
                        ...
                        { key: 'FreightExpence', headerText: 'Freight Expense', unbound: true,
                          dataType: 'number', format: '0.00', width: '20%', formula: 'CalculateFreightExpence' },
