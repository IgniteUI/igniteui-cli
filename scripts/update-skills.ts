...
const mappings = [
	{
		...
		dest: join(root, "packages/igx-templates/igx-ts/projects/ai-config/files/skills")
	},
	{
		name: "react",
		...
		dest: join(root, "packages/cli/templates/react/igr-ts/projects/ai-config/files/skills")
	},
	{
		name: "webcomponents",
