 ...
 * It's used as a source for extra steps in prompt sessions for templates and custom templates.
 */
export interface ControlExtraConfiguration {
	...
	/**
	 * The key is used by the template to map the extra config to the specific control property.
	 *  For example filtering extra configuration
