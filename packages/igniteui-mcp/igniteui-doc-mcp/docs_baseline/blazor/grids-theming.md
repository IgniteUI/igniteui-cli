---
title: Blazor Grid theming | Real-Time Blazor Tables | The Lightweight Blazor Web Components table | Infragistics
_description: .
_keywords: Blazor data grid, infragistics, data grids theming, theming, Ignite UI for Blazor, table
_license: commercial
...
# Theme Blazor Data Grid

With the Blazor Theming engine, the Ignite UI for Blazor Grid can be easily customized to match your brand identity.
