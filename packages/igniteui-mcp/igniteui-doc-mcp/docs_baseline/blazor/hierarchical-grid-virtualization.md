...
In Ignite UI for Blazor, the [`IgbHierarchicalGrid`](mcp:get_api_reference?platform=blazor&component=IgbHierarchicalGrid) control virtualizes its content both vertically and horizontally.
