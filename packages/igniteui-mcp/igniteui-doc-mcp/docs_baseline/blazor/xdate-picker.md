---
title: Blazor XDate Picker | Data Visualization Tools | Infragistics
_description: Infragistics' Blazor xdate picker component helps your users select dates. Improve your graphs and visualization with Ignite UI for Blazor!
_keywords: Blazor xdate picker, drop down, Ignite UI for Blazor, Infragistics
...
<div class="container vertical">
    <div class="container vertical">
        <IgbXDatePicker @ref="DatePicker" Height="60px" Width="220px"
                    Value="@SelectedDate"
...
@code {
    ...
    public IgbXDatePicker DatePicker { get; set; }
...
The Blazor XDate Picker editor component consists of three default parts - the text area, a calendar drop-down button, and a clear button. These areas are described below:
...
<div class="container vertical">
    ...
    <div class="container vertical">
        <IgbXDatePicker @ref="DatePicker" Height="60px" Width="300px"
                    Value="@SelectedDate"
