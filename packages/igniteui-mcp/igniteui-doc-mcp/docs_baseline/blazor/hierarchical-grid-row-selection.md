...
This will add the rows which correspond to the data entries with IDs 1, 2 and 5 to the [`IgbHierarchicalGrid`](mcp:get_api_reference?platform=blazor&component=IgbHierarchicalGrid) selection.
