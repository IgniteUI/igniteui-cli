...
This example demonstrates another series type via the [`IgbDataChart`](mcp:get_api_reference?platform=blazor&component=IgbDataChart) where each radial series can be selected with different colors.
