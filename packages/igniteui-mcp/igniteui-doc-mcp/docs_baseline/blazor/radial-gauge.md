...
The following sample demonstrates how setting multiple properties on the same [`IgbRadialGauge`](mcp:get_api_reference?platform=blazor&component=IgbRadialGauge) can transform it to completely different radial gauge.
