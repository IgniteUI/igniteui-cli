...
_description: The Ignite UI for Blazor Dark Theming
_keywords: Blazor Grid, Grid dark theme Ignite UI for Blazor
_license: commercial
...
With the Blazor Theming css, the Ignite UI for Blazor Grid can be easily customized to match your brand identity.
