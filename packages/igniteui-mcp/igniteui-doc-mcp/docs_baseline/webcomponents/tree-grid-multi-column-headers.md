---
title: Web Components Tree Grid Multi-Column Headers - Ignite UI for Web Components
...
_keywords: Multi-Column Headers, Web Components, Tree Grid, IgcTreeGrid, Ignite UI for Web Components, Infragistics
_license: commercial
