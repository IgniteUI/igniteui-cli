...
_description: .
_keywords: Web Components data grid, infragistics, data grids theming, theming, Ignite UI for Web Components, table
_license: commercial
...
# Theme Web Components Data Grid

With the Web Components Theming engine, the Ignite UI for Web Components Grid can be easily customized to match your brand identity.
