---
title: Web Components Data Grid | Horizontal Scrolling | Infragistics
_description: Use Infragistics' Web Components grid component's horizontal scrolling feature to scroll seamlessly through the columns. Check out Ignite UI for Web Components table demos!
_keywords: Web Components Table, Data Grid, column, horizontal, scrolling, Ignite UI for Web Components, Infragistics
