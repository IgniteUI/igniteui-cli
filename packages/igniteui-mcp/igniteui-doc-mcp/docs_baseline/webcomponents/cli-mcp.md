---
title: Web Components Ignite UI CLI MCP | Infragistics
_description: Connect Ignite UI CLI MCP to your AI client to scaffold projects, modify existing apps, create and update components, and ask documentation questions for Ignite UI for Web Components. Learn the setup options for VS Code, GitHub, Cursor, Claude Desktop, Claude Code, JetBrains, and other MCP clients.
...
> _"Create a new Ignite UI for Web Components project in this folder, use the recommended defaults, and add a starter dashboard page with sample data."_
...
- One of the following starting points:
  ...
  - an existing Ignite UI for Web Components project you want to continue working on
