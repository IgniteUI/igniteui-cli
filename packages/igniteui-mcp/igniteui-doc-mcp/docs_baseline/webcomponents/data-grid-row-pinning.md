---
title: Web Components Data Grid | Row Pinning |  Infragistics
_description: Use Infragistics' Web Components grid component's row pinning feature in order to lock row change row order with a rich and easy to use API. Check out Ignite UI for Web Components table demos!
_keywords: Web Components Table, Data Grid, row pinning, Ignite UI for Web Components, Infragistics
