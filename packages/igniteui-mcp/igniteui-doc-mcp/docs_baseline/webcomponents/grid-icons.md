---
title: Web Components {ComponentTitle} Customize Icons- Infragistics
_description: Configure custom icons for Web Components Grid.
_keywords: icons, custom icons, igniteui for Web Components, {ComponentKeywords}, Ignite UI for Web Components, Infragistics
_license: MIT
