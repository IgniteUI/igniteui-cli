---
title: Web Components Data Grid | Filtering | Infragistics
_description: Use Infragistics' Ignite UI for Web Components grid component to perform expressive sort conditions and return data easily. View Ignite UI for Web Components table's demo for more information!
_keywords: Web Components Table, Data Grid, column, filtering, filter expressions, filter operands, Ignite UI for Web Components, Infragistics
...
# Web Components Grid Filtering Overview

The Ignite UI for Web Components Data Table / Data Grid includes column filtering with both a filter row and API that gives you the ability to perform expressive sort conditions based on the data type of the column being filtered.
...
As seen above, setting the [`filterUIType`](https://www.infragistics.com/products/ignite-ui-web-components/api/docs/typescript/latest/classes/igniteui_webcomponents_grids.igcdatagridcomponent.html#filterUIType) property to FilterRow will enables the record filtering record to the user interface where the user can specify filter criteria to filter records. Records that do not match the specified filter criteria will be hidden.

Filtering is also exposed in the column options UI by hovering a field and clicking the vertical ellipsis. This is achieved when setting the [`filterUIType`](https://www.infragistics.com/products/ignite-ui-web-components/api/docs/typescript/latest/classes/igniteui_webcomponents_grids.igcdatagridcomponent.html#filterUIType) to ColumnOptions. Please refer to the sample below.

## Filter Expressions

In the example below, the data grid's FilterExpressions collection is updated to incorporate custom [`filterExpressions`](https://www.infragistics.com/products/ignite-ui-web-components/api/docs/typescript/latest/classes/igniteui_webcomponents_grids.igcdatagridcomponent.html#filterExpressions).
...
Columns can be given a custom [`IgcFilterOperand`](https://www.infragistics.com/products/ignite-ui-web-components/api/docs/typescript/latest/classes/igniteui_webcomponents_grids.igcfilteroperand.html) that will appear in the filter-row operand dropdown. The key requirements is to ensure the operand is given a [`displayName`](https://www.infragistics.com/products/ignite-ui-web-components/api/docs/typescript/latest/classes/igniteui_webcomponents_grids.igcfilteroperand.html#displayName) and to utilize the `FilterRequested` event on the operand so you can apply a [`filterFactory`](https://www.infragistics.com/products/ignite-ui-web-components/api/docs/typescript/latest/classes/igniteui_webcomponents_grids.igcfilteroperand.html#filterFactory), which is responsible for assigning the operator and value you wish to the filter the column by, e.g. StartsWith with value of "A".

In addition, the grid's [`filterLogicalOperator`](https://www.infragistics.com/products/ignite-ui-web-components/api/docs/typescript/latest/classes/igniteui_webcomponents_grids.igcdatagridcomponent.html#filterLogicalOperator) property is responsible for indicating how filters across fields are combined:

- [`And`](https://www.infragistics.com/products/ignite-ui-web-components/api/docs/typescript/latest/enums/igniteui_webcomponents_grids.filterlogicaloperator.html#And) logical operator. In order for a successful match, all conditions have to pass.
- [`Or`](https://www.infragistics.com/products/ignite-ui-web-components/api/docs/typescript/latest/enums/igniteui_webcomponents_grids.filterlogicaloperator.html#Or) logical operator. In order for a successful match, at least one of the conditions have to pass.
...
- [`displayName`](https://www.infragistics.com/products/ignite-ui-web-components/api/docs/typescript/latest/classes/igniteui_webcomponents_grids.igcfilteroperand.html#displayName)
- [`filterExpressions`](https://www.infragistics.com/products/ignite-ui-web-components/api/docs/typescript/latest/classes/igniteui_webcomponents_grids.igcdatagridcomponent.html#filterExpressions)
- [`filterFactory`](https://www.infragistics.com/products/ignite-ui-web-components/api/docs/typescript/latest/classes/igniteui_webcomponents_grids.igcfilteroperand.html#filterFactory)
- [`filterLogicalOperator`](https://www.infragistics.com/products/ignite-ui-web-components/api/docs/typescript/latest/classes/igniteui_webcomponents_grids.igcdatagridcomponent.html#filterLogicalOperator)
- [`IgcFilterOperand`](https://www.infragistics.com/products/ignite-ui-web-components/api/docs/typescript/latest/classes/igniteui_webcomponents_grids.igcfilteroperand.html)
- `FilterRequested`
- [`filterUIType`](https://www.infragistics.com/products/ignite-ui-web-components/api/docs/typescript/latest/classes/igniteui_webcomponents_grids.igcdatagridcomponent.html#filterUIType)
