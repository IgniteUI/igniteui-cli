---
title: Web Components Grid Column Data Types - Ignite UI for Web Components
...
_keywords: Column Data Type , Web Components, Grid, IgcGrid, Ignite UI for Web Components, Infragistics
_license: commercial
...
# Web Components Grid Column Types Overview

The Web Components Grid provides a default handling of **number**, **string**, **date**, **boolean**, **currency** and **percent** column data types, based on which the appearance of the default and editing templates will be present.

<!-- ComponentStart: Grid, TreeGrid -->

## Web Components Grid Column Types Example
...
The [`IgcGridComponent`](mcp:get_api_reference?platform=webcomponents&component=IgcGridComponent) accepts date values of type **Date object**, **Number (milliseconds)**, **An ISO date-time string**. This section shows [how to configure a custom display format](../data-grid.md#custom-display-format).
...
Upon editing of cell's value the **currency symbol** will be visible as suffix or prefix. More about that could be found in the official [Cell editing topic](cell-editing.md#web-components-grid-cell-editing-and-edit-templates-example).
...
- [`locale`](mcp:get_api_reference?platform=webcomponents&component=IgcGridComponent&member=locale)
