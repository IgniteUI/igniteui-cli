---
title: Web Components Grid theming | Real-Time Web Components Tables | The Lightweight Web Components Web Components table | Infragistics
_description: The Ignite UI for Web Components Dark Theming
_keywords: Web Components Grid, Grid dark theme Ignite UI for Web Components
_license: commercial
...
# Theme Web Components Grid

With the Web Components Theming css, the Ignite UI for Web Components Grid can be easily customized to match your brand identity.
