---
title: Web Components Grid Lite Theming | Ignite UI for Web Components | MIT license
_description: Styling the Grid Lite in Ignite UI for Web Components happens easily and quickly. See demos and examples! Try our open-source components and build your next app.
_keywords: styling, theming, Web Components, {ComponentKeywords}, Ignite UI for Web Components, Infragistics
