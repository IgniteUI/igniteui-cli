---
title: Web Components Data Grid | Row Highlighting | Infragistics
_description: Configuring the row highlight of the Infragistics' Web Components data grid on mouse over. Learn how to configure row highlight for the Ignite UI for Web Components table.
_keywords: Web Components Table, Data Grid, row highlighting, Ignite UI for Web Components, Infragistics
...
Highlighting records in the Web Components data can be toggled by setting the [`isRowHoverEnabled`](https://www.infragistics.com/products/ignite-ui-web-components/api/docs/typescript/latest/classes/igniteui_webcomponents_grids.igcdatagridcomponent.html#isRowHoverEnabled) boolean property of the Web Components grid. Note, this is enabled by default.

In addition, the color is configurable by setting the [`rowHoverBackground`](https://www.infragistics.com/products/ignite-ui-web-components/api/docs/typescript/latest/classes/igniteui_webcomponents_grids.igcdatagridcomponent.html#rowHoverBackground) string property to a hex value.
...
- [`isRowHoverEnabled`](https://www.infragistics.com/products/ignite-ui-web-components/api/docs/typescript/latest/classes/igniteui_webcomponents_grids.igcdatagridcomponent.html#isRowHoverEnabled)
- [`rowHoverBackground`](https://www.infragistics.com/products/ignite-ui-web-components/api/docs/typescript/latest/classes/igniteui_webcomponents_grids.igcdatagridcomponent.html#rowHoverBackground)
