---
title: React Data Grid | Horizontal Scrolling | Infragistics
_description: Use Infragistics' React grid component's horizontal scrolling feature to scroll seamlessly through the columns. Check out Ignite UI for React table demos!
_keywords: React Table, Data Grid, column, horizontal, scrolling, Ignite UI for React, Infragistics
