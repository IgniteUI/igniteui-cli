---
title: Ignite UI for React Accessibility Compliance | Ignite UI for React | Infragistics
_description: Ignite UI for React Accessibility Support and Compliance - Section 508 Compliance, WCAG and ARIA .
_keywords: accessibility, React, ignite ui for React, infragistics
_license: MIT
mentionedTypes: []
...
As the leading global provider of UI and UX tools for developers, our React team at Infragistics is committed to providing components and tools that make it easier for you to create the best possible user experience. Our goal is to enable you to focus on crafting the best applications and the best user experience for all users.

Here you can find specific information regarding the accessibility support and compliance for our React grids, charts, and UI components and controls within Ignite UI for React.
...
### Ignite UI for React Compliance with Section 508
...
> \[!WARNING]
> The table above is relevant only to the **Default theme**of Ignite UI for React theming library. The checklist compliance might be different when it comes to custom themes, typography and any visual changes related to animations and colors.
