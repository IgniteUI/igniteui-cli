---
title: React Data Grid | Row Pinning |  Infragistics
_description: Use Infragistics' React grid component's row pinning feature in order to lock row change row order with a rich and easy to use API. Check out Ignite UI for React table demos!
_keywords: React Table, Data Grid, row pinning, Ignite UI for React, Infragistics
