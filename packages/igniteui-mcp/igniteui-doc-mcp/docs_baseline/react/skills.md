---
title: AI-Assisted Development | AI Skills | Ignite UI for React | Infragistics
...
_keywords: Ignite UI for React, copilot skills, ai assisted development, github copilot, cursor, windsurf, claude, jetbrains ai
_license: MIT
mentionedTypes: []
...
Ignite UI for React ships with **Agent Skills** — structured knowledge files that teach AI coding assistants (GitHub Copilot, Cursor, Windsurf, Claude, JetBrains AI, etc.) how to work with Ignite UI for React. These skill files provide context-aware guidance on components, grids, data operations, and theming, enabling your AI assistant to generate accurate, idiomatic code that follows best practices.
...
This approach wires the skills permanently into your project so that every AI session automatically follows the Ignite UI for React guidelines — no copy-pasting required.
...
This project uses Ignite UI for React. Follow the guidelines in the skill files below:
...
2. Paste the contents of the relevant `SKILL.md` files into it. For example:
    ...
    This project uses Ignite UI for React. Always follow these guidelines:
...
If Ignite UI for React is already installed in your project, the skill files are available under `node_modules`. To copy them into your project (e.g. for use with General AI Agents under `.agents/skills/`), run:
