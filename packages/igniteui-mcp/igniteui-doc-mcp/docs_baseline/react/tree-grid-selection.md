...
The sample below demonstrates three types of **cell selection** behaviors in the [`IgrTreeGrid`](mcp:get_api_reference?platform=react&component=IgrTreeGrid). Use the buttons below to enable each of the available selection modes.
