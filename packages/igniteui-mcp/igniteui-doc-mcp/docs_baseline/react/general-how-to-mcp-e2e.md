...
> _"Add an Orders page with an Ignite UI for React grid. Include columns for Order ID, Customer Name, Order Date, and Total Amount, and bind the grid to sample data."_
...
> _"What filtering options does the React grid support, and which ones are the best fit for a simple orders table?"_

> _"What events does the combo component expose, and which one should I use for selection changes?"_

> _"Which Ignite UI for React component is the best fit for a side navigation layout, and why?"_
