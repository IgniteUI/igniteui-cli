---
title: React Data Grid | Filtering | Infragistics
_description: Use Infragistics' Ignite UI for React grid component to perform expressive sort conditions and return data easily. View Ignite UI for React table's demo for more information!
_keywords: React Table, Data Grid, column, filtering, filter expressions, filter operands, Ignite UI for React, Infragistics
...
As seen above, setting the [`filterUIType`](https://www.infragistics.com/products/ignite-ui-react/api/docs/typescript/latest/classes/igniteui_react_grids.igrdatagrid.html#filterUIType) property to FilterRow will enables the record filtering record to the user interface where the user can specify filter criteria to filter records. Records that do not match the specified filter criteria will be hidden.

Filtering is also exposed in the column options UI by hovering a field and clicking the vertical ellipsis. This is achieved when setting the [`filterUIType`](https://www.infragistics.com/products/ignite-ui-react/api/docs/typescript/latest/classes/igniteui_react_grids.igrdatagrid.html#filterUIType) to ColumnOptions. Please refer to the sample below.

## Filter Expressions

In the example below, the data grid's FilterExpressions collection is updated to incorporate custom [`filterExpressions`](https://www.infragistics.com/products/ignite-ui-react/api/docs/typescript/latest/classes/igniteui_react_grids.igrdatagrid.html#filterExpressions).
...
Columns can be given a custom [`IgrFilterOperand`](https://www.infragistics.com/products/ignite-ui-react/api/docs/typescript/latest/classes/igniteui_react_grids.igrfilteroperand.html) that will appear in the filter-row operand dropdown. The key requirements is to ensure the operand is given a [`displayName`](https://www.infragistics.com/products/ignite-ui-react/api/docs/typescript/latest/classes/igniteui_react_grids.igrfilteroperand.html#displayName) and to utilize the `FilterRequested` event on the operand so you can apply a [`filterFactory`](https://www.infragistics.com/products/ignite-ui-react/api/docs/typescript/latest/classes/igniteui_react_grids.igrfilteroperand.html#filterFactory), which is responsible for assigning the operator and value you wish to the filter the column by, e.g. StartsWith with value of "A".

In addition, the grid's [`filterLogicalOperator`](https://www.infragistics.com/products/ignite-ui-react/api/docs/typescript/latest/classes/igniteui_react_grids.igrdatagrid.html#filterLogicalOperator) property is responsible for indicating how filters across fields are combined:

- [`And`](https://www.infragistics.com/products/ignite-ui-react/api/docs/typescript/latest/enums/igniteui_react_grids.filterlogicaloperator.html#And) logical operator. In order for a successful match, all conditions have to pass.
- [`Or`](https://www.infragistics.com/products/ignite-ui-react/api/docs/typescript/latest/enums/igniteui_react_grids.filterlogicaloperator.html#Or) logical operator. In order for a successful match, at least one of the conditions have to pass.
...
- [`displayName`](https://www.infragistics.com/products/ignite-ui-react/api/docs/typescript/latest/classes/igniteui_react_grids.igrfilteroperand.html#displayName)
- [`filterExpressions`](https://www.infragistics.com/products/ignite-ui-react/api/docs/typescript/latest/classes/igniteui_react_grids.igrdatagrid.html#filterExpressions)
- [`filterFactory`](https://www.infragistics.com/products/ignite-ui-react/api/docs/typescript/latest/classes/igniteui_react_grids.igrfilteroperand.html#filterFactory)
- [`filterLogicalOperator`](https://www.infragistics.com/products/ignite-ui-react/api/docs/typescript/latest/classes/igniteui_react_grids.igrdatagrid.html#filterLogicalOperator)
- [`IgrFilterOperand`](https://www.infragistics.com/products/ignite-ui-react/api/docs/typescript/latest/classes/igniteui_react_grids.igrfilteroperand.html)
- `FilterRequested`
- [`filterUIType`](https://www.infragistics.com/products/ignite-ui-react/api/docs/typescript/latest/classes/igniteui_react_grids.igrdatagrid.html#filterUIType)
