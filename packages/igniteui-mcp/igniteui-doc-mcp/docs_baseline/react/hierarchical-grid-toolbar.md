---
title: React Hierarchical Grid for Ignite UI for React for
_description: Use React Hierarchical Grid for essential UI operations. Hosts different UI controls for the Grid’s features - column hiding, pinning, excel exporting, etc.
