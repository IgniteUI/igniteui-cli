---
title: React Data Grid | Real-Time Data Grid and Tables | Localization | Infragistics
_description: Use Infragistics' Ignite UI for React Data Table & Grid which supports localization. View Ignite UI for React table tutorials!
...
# React Grid Localization

The Ignite UI for React Data Table / Data Grid supports localizing the resource strings specific to the column options pop-up and summaries. Note, this is not intended to be used nor capable of translating the data.

## React Grid Localization Example
