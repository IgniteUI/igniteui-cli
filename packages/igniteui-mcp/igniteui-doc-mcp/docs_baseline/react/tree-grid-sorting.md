...
The [`IgrTreeGrid`](mcp:get_api_reference?platform=react&component=IgrTreeGrid) provides a solution for this problem by indicating the index of each sorted column.
