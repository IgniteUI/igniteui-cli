...
* **upgrade-packages:** align React 19.4.0+ licensing migration for command/schematic by upgrading `igniteui-react-dockmanager` and no longer migrating `igniteui-react` ([#1641](https://github.com/IgniteUI/igniteui-cli/pull/1641))
